...
export default function Hero() {
  useEffect(() => {
    const msg = new SpeechSynthesisUtterance("Hi, I'm Amrita's portfolio. Let me show you something cool.");
    window.speechSynthesis.speak(msg);
  }, []);

  return (
    <section className="pt-24 pb-16 text-center bg-gradient-to-b from-indigo-50 to-white">
      <img src="/assets/images/profile.jpg" alt="Amrita Pal" className="w-32 h-32 mx-auto rounded-full shadow-lg" />
